...
public class RedisUtility<T> {
	...
	@Autowired
	public RedisUtility(RedisTemplate<String, T> redisTemplate) {
		super();
	...
	public void putMap(String redisKey, Object key, User user) {
		hashOperations.put(redisKey, key, (T) user);
	}
	
	public T getMapAsSibgleEntry(String redisKey, Object key) {
